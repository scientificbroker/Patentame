...
const STRINGS_DATA: StringLib = {
    en: {
        ...
        sections: [
            ...
            { id: 'technicalSector', title: 'Technical Sector & IPC Classification', helpText: 'Specify the macro-industrial field, exact subfield, operational objective, and International Patent Classification (IPC/CIP) codes.', placeholder: 'e.g.,\nThe present invention falls within the general field of Biotechnology and Medical Engineering, specifically relating to non-invasive continuous vital sign monitoring systems.\n\nIn particular, the primary technical object addresses real-time optical biomarker filtering to enable early diagnostic alerts without blood sampling.\n\nAccording to the International Patent Classification (IPC), this innovation falls under technical class A61B 5/00 (Diagnostic measurements) and G16H 40/60 (Healthcare ICT).', wipoRecommendation: 'WIPO / PCT Rule 5.1 Recommendation: Never state just a single phrase. Structure into 3 clear layers: (1) General Macro-Sector, (2) Exact Technical Subfield/Application, and (3) Applicable IPC Classification Codes.' },
    ...
    es: {
        ...
        sections: [
            ...
            { id: 'technicalSector', title: 'Sector Técnico y Clasificación CIP', helpText: 'Especifica el macro-sector industrial, el subcampo exacto de aplicación, el objeto técnico y las clases de la Clasificación Internacional de Patentes (CIP / IPC).', placeholder: 'Ej:\nLa presente invención se enmarca en el campo técnico general de Biotecnología e Ingeniería Biomédica, y más específicamente se relaciona con sistemas de monitorización continua no invasiva y sensores optoelectrónicos.\n\nEn particular, el objeto tecnológico de esta invención comprende la captura en tiempo real y filtrado de biomarcadores para diagnóstico temprano sin extracción sanguínea.\n\nDe acuerdo con la Clasificación Internacional de Patentes (CIP / IPC), esta tecnología se sitúa preferentemente en las clases: A61B 5/00 (Medición con fines de diagnóstico) y G16H 40/60 (TIC sanitarias).', wipoRecommendation: 'Recomendación WIPO / Regla 5.1 PCT: Nunca redactes una sola frase breve. Estructura siempre en 3 niveles formales: (1) Macro-Sector General, (2) Subcampo o Aplicación Técnica Específica, y (3) Códigos de Clasificación Internacional de Patentes (CIP/IPC).' },
