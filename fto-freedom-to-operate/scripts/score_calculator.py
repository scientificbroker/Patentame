...
Calculadora de score de riesgo FTO por patente (0-100).

Uso como script: python scripts/score_calculator.py
Uso como módulo: from scripts.score_calculator import calculate_fto_score
"""
...
if __name__ == "__main__":
    ...
    # Ejemplo de score global con múltiples patentes
    multiple = [result, calculate_fto_score({
        "claim_coverage": 0.3, "claim_mode": "none", "is_active": True,
        "territories_overlap": 0.2, "years_remaining": 3,
        "holder_type": "individual", "claim_breadth": "narrow",
        "prior_art_available": "robust", "technical_similarity": "low",
    })]

    global_result = calculate_global_fto_score(multiple)
    print(f"\nSCORE GLOBAL: {global_result['global_score']}/100")
    print(f"Recomendación: {global_result['recommendation']}")
