...
Ver `scripts/score_calculator.py` para la implementación automatizable.
...
Territorios: [LISTA]
Elaborado por: Patentame FTO Analyzer v2.0 | Biogenia Lab
...
- `scripts/score_calculator.py` — Calculadora de score de riesgo (importable como módulo)
- `scripts/analizar_reivindicacion_fto.py` — Interfaz interactiva para análisis individual de claims
- `scripts/generar_informe_fto.py` — Generador interactivo de informe FTO completo
